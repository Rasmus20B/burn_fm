            ...
            match &path.iter().as_slice() {
                ...
                [x, 3, 5, y] => {
                    if x >= &128 {
                        if chunk.ctype == ChunkType::PathPush {
                            ...
                            fmp_file.tables[*x - 129].fields.insert(*y as u16, component::FMComponentField { 
                                data_type: "".to_string(),
                ...
                [3, 16, 5, x] => {
                    ...
                    // println!("Path: {:?}. reference: {:?}, ref_data: {:?}", 
                             ...
                             // s);
                    if chunk.ctype == ChunkType::PathPush {
                        fmp_file.tables.push(component::FMComponentTable { 
                        ...
                        match chunk.ref_simple.unwrap_or(0) {
                            metadata_constants::COMPONENT_NAME => { fmp_file.tables[x - 129].table_name = s },
                            _ => {}
                        }
                    }
                }
